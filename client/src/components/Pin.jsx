...
const Pin = ({ pin }) => {
  ...
  //1, [2, 3, 1] -> [1].lenght -> 1 -> !!1 -> true
  //4, [2, 3, 1] -> [].lenght -> 0 -> !!0 -> false
  ...
  return (
    <div className='m-2'>
      ...
      >
        <img src={urlFor(pin.image).width(250).url()} alt="user-post" className='rounded-lg w-full ' />
        {postHover && (
      ...
      className="flex gap-2 mt-2 items-center">
        <img src={pin.postedBy?.image} alt="user img" 
